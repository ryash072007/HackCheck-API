...
```json
{
  "easy_max_score": 200,  // Optional
  "medium_max_score": 300,  // Optional
  "hard_max_score": 400,  // Optional
  "score_decrement_interval_seconds": 600,  // Optional
  "score_decrement_per_interval": 10  // Optional
}
```
...
### 7.2 Open the django admin portal: http://localhost:8000/api_admin/
